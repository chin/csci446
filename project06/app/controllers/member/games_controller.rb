class Member::GamesController < Member::MemberController
  ...
  def edit
    ...
    unless @game.user.eql? current_user
      flash[:alert] = "You cannot edit games that are not yours."
  ...
  def create
    ...
    respond_to do |format|
      if @game.save
        format.html { redirect_to member_root_url, :notice => '#{@game.name} was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @game.update_attributes(params[:game])
        format.html { redirect_to member_root_url, :notice => '#{@game.name} was successfully updated.' }
